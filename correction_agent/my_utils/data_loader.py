...
import math
import os
from my_utils.norm import reshape_fields_atmos, reshape_fields_ocean, reshape_fields_sst
...
class GetDataset(Dataset):
    ...
    def __getitem__(self, global_idx):
        ...
        return np.concatenate((inp_atmos, inp_sst), axis=0), inp_ocean, np.concatenate((tar_atmos, tar_ocean), axis=0)
