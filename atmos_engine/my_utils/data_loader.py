...
import h5py
import math
from my_utils.norm import reshape_fields, reshape_fields_ocean
    ...
    def __getitem__(self, global_idx):
        ...
        if self.params.multi_steps_finetune == 1:
            ...
            ocean = reshape_fields_ocean( 
                    self.files_ocean[year_idx][(local_idx-self.dt*self.n_history):(local_idx+1):self.dt, self.ocean_channels, :180, :360], 
                    'ocean', 
                    self.params, 
                    self.train, 
                    self.normalize, 
